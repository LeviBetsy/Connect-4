public class Checker {
    ...
    private boolean checkHorizontal(char[][] b) {
        // count keeps track of how many of the same token are next to each other in a
        // row
        int count = 0;

        // for loop keeps track of which row is being checked; nested for loop keeps
        // track of the column
    ...
    private boolean checkVertical(char[][] b) {
        ...
        // for loop keeps track of column being checked while the nested for loop keeps
        // track of the row
        for (int col = 0; col < 7; col++) {
            char token = b[col][0];
